load ./1ake_laplacian_mode_3.pdb
hide everything
show cartoon
color gray80

select hinge_residues, (chain A and resi 8 and resn ALA) + (chain A and resi 11 and resn ALA) + (chain A and resi 12 and resn GLY) + (chain A and resi 15 and resn THR) + (chain A and resi 56 and resn GLY) + (chain A and resi 58 and resn LEU) + (chain A and resi 89 and resn THR) + (chain A and resi 90 and resn ILE) + (chain A and resi 112 and resn PRO) + (chain A and resi 129 and resn SER) + (chain A and resi 158 and resn ASP) + (chain A and resi 163 and resn THR) + (chain A and resi 178 and resn LEU) + (chain A and resi 181 and resn TYR) + (chain A and resi 199 and resn THR) + (chain A and resi 202 and resn VAL) + (chain B and resi 3 and resn ILE) + (chain B and resi 6 and resn LEU) + (chain B and resi 26 and resn ILE) + (chain B and resi 106 and resn VAL) + (chain B and resi 157 and resn LYS) + (chain B and resi 160 and resn GLN) + (chain B and resi 163 and resn THR) + (chain B and resi 171 and resn TYR) + (chain B and resi 193 and resn TYR)
